...
def validate(df: DataFrame, rules: List[RuleDef], baseline_provider=None) -> ValidationReport:
    """
...
def _validate_table_level(df: DataFrame, rules: List[RuleDef], baseline_provider) -> List[ValidationResult]:
