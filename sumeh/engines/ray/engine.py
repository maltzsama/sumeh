...
from sumeh.core.models import ValidationReport, MetricResult, ValidationResult, ValidationLevel, ValidationStatus
    ...
    for rule in rules:
        ...
        try:
            ...
            if rule.check_type == "is_complete":
                ...
                completeness_rate = (total_rows - null_count) / total_rows if total_rows > 0 else 1.0
                ...
                pass_rate = (total_rows - fail_count) / total_rows if total_rows > 0 else 1.0
                metric_obj = MetricResult(
                    metric_type=rule.check_type,
                    field=str(rule.field),
                    value=pass_rate,
